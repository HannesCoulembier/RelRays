	...
	namespace Defaults {
		...
		void Init() {
			...
			Sensors::EyeCamera.ColorSpectra = ColorSpectra::Create(
				...
				glm::vec4(1.0f, 1.0f, 1.0f, 0.0f) * 2.0f / 1.0f
			);

			Sensors::BlockCamera.RedSpectrum = Spectrum::Create(
				620.0f * Units::nm,
				720.0f * Units::nm,
				{
				1.0f,
				...
				1.0f,
				1.0f,
				}); // 80 entries, spacing: 1nm
			Sensors::BlockCamera.GreenSpectrum = Spectrum::Create(
				500.0f * Units::nm,
				600.0f * Units::nm,
				{
				1.0f,
				...
				1.0f,
				1.0f,
				}); // 100 entries, spacing: 1nm
			Sensors::BlockCamera.BlueSpectrum = Spectrum::Create(
				380.0f * Units::nm,
				480.0f * Units::nm,
				{
				1.0f,
			...
			Sensors::BlockCamera.ColorSpectra = ColorSpectra::Create(
				EmptySpectrum,
				Sensors::BlockCamera.RedSpectrum,
				Sensors::BlockCamera.GreenSpectrum,
				Sensors::BlockCamera.BlueSpectrum,
