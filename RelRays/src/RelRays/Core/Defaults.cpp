...
namespace RelRays {
	namespace Defaults {
		...
		const LoFox::Ref<Spectrum> SonyCamera::RedSensorSpectrum = Spectrum::Create(
			346.0f * Units::nm,
			1042.0f * Units::nm,
			{
		...
		const LoFox::Ref<Spectrum> SonyCamera::GreenSensorSpectrum = Spectrum::Create(
			346.0f * Units::nm,
			1042.0f * Units::nm,
			{
		...
		const LoFox::Ref<Spectrum> SonyCamera::BlueSensorSpectrum = Spectrum::Create(
			346.0f * Units::nm,
			1042.0f * Units::nm,
			{
		...
		const LoFox::Ref<ColorSpectra> SonyCamera::SensorColorSpectra = ColorSpectra::Create(
			EmptySpectrum,
			RedSensorSpectrum,
			GreenSensorSpectrum,
			BlueSensorSpectrum,
		...
		const LoFox::Ref<Spectrum> EyeCamera::RedSensorSpectrum = Spectrum::Create(
			380.0f * Units::nm,
			770.0f * Units::nm, 
			{
				 0.000f,//380nm
		...
		const LoFox::Ref<Spectrum> EyeCamera::GreenSensorSpectrum = Spectrum::Create(
			380.0f * Units::nm,
			770.0f * Units::nm,
			{
				 0.000f,//380nm
		...
		const LoFox::Ref<Spectrum> EyeCamera::BlueSensorSpectrum = Spectrum::Create(
			380.0f * Units::nm,
			770.0f * Units::nm,
			{
				 0.000f,//380nm
		...
		const LoFox::Ref<ColorSpectra> EyeCamera::SensorColorSpectra = ColorSpectra::Create(
			EmptySpectrum,
			RedSensorSpectrum,
			GreenSensorSpectrum,
			BlueSensorSpectrum,
